...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ 𝐉𝐎𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐋 ⚡', url=f"https://t.me/DK_Gru"),
            ],
            [
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🔥 𝐉𝐎𝐈𝐍 𝐌𝐘 𝐂𝐇𝐀𝐍𝐍𝐋 🔥", url=invite_link.invite_link
                )
            ]
        ]
        ...
        if message.command[1] != "subscribe":
            try:
                ...
                btn.append([InlineKeyboardButton(" 🔄 𝐑𝐄𝐅𝐑𝐄𝐒𝐇 ", callback_data=f"{pre}#{file_id}")])
            except (IndexError, ValueError):
                btn.append([InlineKeyboardButton(" 🔄 𝐑𝐄𝐅𝐑𝐄𝐒𝐇 ", url=f"https://t.me/{temp.U_NAME}?start={message.command[1]}")])
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('❣ 𝐉𝐎𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐋 ❣', url='https://t.me/DK_Gru') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
